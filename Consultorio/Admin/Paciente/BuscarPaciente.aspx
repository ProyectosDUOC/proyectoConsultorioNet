<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="BuscarPaciente.aspx.cs" Inherits="Consultorio.Admin.Paciente.BuscarPaciente" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        ...
        <table>
            ...
            <tr>                
                <td><asp:Label ID="lblGSanguineo" runat="server" Text=" "></asp:Label></td>
                <td><asp:Label ID="lblRSanguineo" runat="server" Text=" "></asp:Label></td>      
                <td><asp:Label ID="lblAlergia" runat="server" Text=" " ></asp:Label></td>             
            </tr>
        </table>
        <br>
        <br>
            ...
            Height="40px" onclick="btn_Atras_Click"/>
    </div>
</asp:Content>
