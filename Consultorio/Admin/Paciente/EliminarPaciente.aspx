<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="EliminarPaciente.aspx.cs" Inherits="Consultorio.Admin.Paciente.EliminarPaciente" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        ...
        <br>
            ...
            <asp:Button ID="btnCancelar" runat="server" Text="Cancelar" Height="47px" 
            Width="232px" onclick="btnCancelar_Click"  />
