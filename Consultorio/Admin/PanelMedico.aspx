<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="PanelMedico.aspx.cs" Inherits="Consultorio.Admin.PanelMedico" %>
    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            <div>
                ...
                <center>
                    <asp:Button ID="btn_Agregar" runat="server" Text="Agregar" Width="288px" Height="55px" onclick="btn_Agregar_Click" />
                    <br />
                    <br>
                    ...
                    <br />
                    <br>
                    <asp:Button ID="btn_Eliminar" runat="server" Text="Eliminar" Width="288px" Height="55px" onclick="btn_Eliminar_Click" />
                    <br />
                    <br>
