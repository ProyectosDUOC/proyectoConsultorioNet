<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="PanelSecretaria.aspx.cs" Inherits="Consultorio.Admin.PanelSecretaria" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <div>
                ...
                <center>
                    <asp:Button ID="btn_Agregar" runat="server" Text="Agregar" Width="288px" Height="55px" onclick="btn_Agregar_Click1" /></br></br>
