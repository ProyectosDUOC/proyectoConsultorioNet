    ...
    <div>
        <table>
            ...
            <tr>
                ...
                <td>-<asp:TextBox ID="txt_dv" runat="server" MaxLength="1" Width="35px"></asp:TextBox></td>
                <td>
        ...
        <a href="../PanelPaciente.aspx" style="font-size: xx-large; font-weight: 700">Volver</a>
    </div>
</asp:Content>
